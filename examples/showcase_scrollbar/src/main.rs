...
impl ZellijPlugin for State {
    fn load(&mut self, _: BTreeMap<String, String>) {
        ...
        self.scroll_state = ScrollbarState::new(3);
    }
...
fn ui(frame: &mut Frame, text: Vec<Line>, state: &ScrollbarState) {
...
fn render_scrollbar(frame: &mut Frame, area: Geometry, text: Vec<Line>, state: &ScrollbarState) {
    frame.render_widget(
